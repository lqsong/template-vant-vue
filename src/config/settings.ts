 ...
 * @description: 站点名称
 */
export const siteTitle: TSiteTitle = "Template-Vant-Vue";

/**
 * @description: 站点本地存储Token 的 Key值
 */
export const siteTokenKey: TSiteTokenKey = "template-vant-vue-token";
 ...
 */
export const themeStorageKey: TThemeStorageKey = "template-vant-vue-theme";
